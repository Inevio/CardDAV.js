	...
	VCardToJson : function( data ){
		...
		var data = {
		  ...
		  org : {
		    ...
		    department: 'Fishing Team'
		  },

		  title: 'Shrimp Man',

		  phone : [
		    { type : 'cell', value : '+1-111-555-1212' },
		    { type : 'iphone', value : '+1-404-555-1212' },
		    { type : 'home', value : '+1-111-555-1212' },
		    { type : 'work', value : '+1-404-555-1212' },
		    { type : 'main', value : '+1-111-555-1212' },
		    { type : 'homeFax', value : '+1-404-555-1212' },
		    { type : 'workFax', value : '+1-111-555-1212' },
		    { type : 'otherFax', value : '+1-404-555-1212' },
		    { type : 'pager', value : '+1-111-555-1212' },
		    { type : 'other', value : '+1-404-555-1212' }
		  ],

		  email : [
		    { type : 'home', value : 'forrest@gump.com' },
		    { type : 'work', value : 'forrest@bubbagump.com' },
		    { type : 'other', value : 'ilovejenny@hotmail.com' }
		  ],

		  address : [
		    { type : 'work', street : '100 Waters Edge', code : '30314', city : 'Baytown', region : 'LA', country : 'United States of America' },
		    { type : 'home', street : '42 Plantation St.', code : '30314', city : 'Baytown', region : 'LA', country : 'United States of America' },
		    { type : 'other', street : '180 Orange Street', code : '04242', city : 'Winchester', region : 'DE', country : 'United States of America' }
		  ],

		  url : [
		    { type : 'home', value : 'gump.com' },
		    { type : 'work', value : 'bubbagump.com' },
		    { type : 'other', value : 'runforrest.com' }
		  ],
